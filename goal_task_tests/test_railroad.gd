...
func test_railroad() -> void:
	var state0 := {"train_1": true, "train_2": true, "train_3": true, "train_4": true, "train_5": true, "train_6": true}

	planner._domains.push_back(the_domain)
	planner.current_domain = the_domain

	planner.declare_actions([Callable(self, "move_train_1"), Callable(self, "move_train_2"), Callable(self, "move_train_3"), Callable(self, "move_train_4"), Callable(self, "move_train_5"), Callable(self, "move_train_6")])
	planner.declare_task_methods("make_train_movement", [Callable(self, "make_train_movement")])
