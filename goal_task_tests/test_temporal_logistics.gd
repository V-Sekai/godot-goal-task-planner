...
#	planner.print_domain()
	...
	stn.add_temporal_constraint(TemporalConstraint.new(0, 0, drive_truck1_duration, TemporalConstraint.TemporalQualifier.AT_END, "drive_truck1"), TemporalConstraint.new(0, 0, load_truck1_duration, TemporalConstraint.TemporalQualifier.AT_START, "load_truck1"))  # No gap between driving and loading

	stn.add_temporal_constraint(TemporalConstraint.new(0, 0, load_truck1_duration, TemporalConstraint.TemporalQualifier.AT_END, "load_truck1"), TemporalConstraint.new(0, 0, drive_truck6_duration, TemporalConstraint.TemporalQualifier.AT_START, "drive_truck6"))  # No gap between loading and driving

	stn.add_temporal_constraint(TemporalConstraint.new(0, 0, drive_truck6_duration, TemporalConstraint.TemporalQualifier.AT_END, "drive_truck6"), TemporalConstraint.new(0, 0, unload_truck1_duration, TemporalConstraint.TemporalQualifier.AT_START, "unload_truck1"))  # No gap between driving and unloading
	...
	stn.add_temporal_constraint(TemporalConstraint.new(0, 0, fly_plane2_duration, TemporalConstraint.TemporalQualifier.AT_END, "fly_plane2"), TemporalConstraint.new(0, 0, load_plane2_duration, TemporalConstraint.TemporalQualifier.AT_START, "load_plane2"))  # No gap between flying and loading

	stn.add_temporal_constraint(TemporalConstraint.new(0, 0, load_plane2_duration, TemporalConstraint.TemporalQualifier.AT_END, "load_plane2"), TemporalConstraint.new(0, 0, unload_plane2_duration, TemporalConstraint.TemporalQualifier.AT_START, "unload_plane2"))  # No gap between loading and unloading
